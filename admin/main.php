...
<div class="box">
	...
	<span class="user"><i class="fa-solid fa-users"></i></span>
	<p class="data"><?php echo $totalEmployees; ?></p>
	<div class="more"><a href="managestaff.php" target="mainframe">MORE INFO</a></div>
</div>
<div class="box">
	<h2>Total departments</h2></span>
	<span><i class="fa-solid fa-building"></i></span>

	<p class="data"><?php echo $totalDepartments; ?></p>
	<div class="more"><a href="managedepart.php" target="mainframe">MORE INFO</a></div>
</div>
<div class="box">
	<h2>Total salary</h2>
	<span><i class=" fa-solid fa-dollar-sign"></i></span>	
<p class="data"><?php echo $totalSalary; ?></p>
<div class="more"><a href="salhistory.php" target="mainframe">MORE INFO</a></div>
</div>
<div class="box">
